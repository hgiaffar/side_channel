...
parser.add_argument("--init_meme_prob", type=str, choices=['UNIFORM','RANDOM', 'CONTROL'],
...
parser.add_argument("--meme_prob_entropy", type=int, help="parameter of symmetric dirichlet distribution - controls entropy of the fixed marginal meme distribution - (0,1)", default=1)
...
elif args.init_meme_prob == 'CONTROL':
  meme_probs = np.random.dirichlet(np.ones((args.num_memes, 1))*args.meme_prob_entropy, 1)
  meme_probs /= meme_probs.sum()
